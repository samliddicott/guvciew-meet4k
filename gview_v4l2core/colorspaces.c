...
void rgb24_to_yu12(uint8_t *out, uint8_t *in, int width, int height)
{
	...
	{
		/* y */
		*py++ =CLIP(0.299 * (in[i] - 128) + 0.587 * (in[i+1] - 128) + 0.114 * (in[i+2] - 128) + 128);
	}
	
	int h = 0;
	for(h = 0; h < height; h += 2)
	{
		int offset = width * 3 * (h + 1);
		for(i = 0; i < (width * 3); i += 6)
		{
			/* u */
			uint8_t u1 = CLIP(((- 0.147 * (in[i] - 128) - 0.289 * (in[i+1] - 128) + 0.436 * (in[i+2] - 128) + 128) +
				(- 0.147 * (in[i+3] - 128) - 0.289 * (in[i+4] - 128) + 0.436 * (in[i+5] - 128) + 128))/2);
			uint8_t u2 = CLIP(((- 0.147 * (in[i+offset] - 128) - 0.289 * (in[i+1+offset] - 128) + 0.436 * (in[i+2+offset] - 128) + 128) +
				(- 0.147 * (in[i+3+offset] - 128) - 0.289 * (in[i+4+offset] - 128) + 0.436 * (in[i+5+offset] - 128) + 128))/2);
			*pu++ = (u1 + u2) / 2;
			/* v*/
			uint8_t v1 =CLIP(((0.615 * (in[i] - 128) - 0.515 * (in[i+1] - 128) - 0.100 * (in[i+2] - 128) + 128) +
				(0.615 * (in[i+3] - 128) - 0.515 * (in[i+4] - 128) - 0.100 * (in[i+5] - 128) + 128))/2);
			uint8_t v2 =CLIP(((0.615 * (in[i+offset] - 128) - 0.515 * (in[i+1+offset] - 128) - 0.100 * (in[i+2+offset] - 128) + 128) +
				(0.615 * (in[i+3+offset] - 128) - 0.515 * (in[i+4+offset] - 128) - 0.100 * (in[i+5+offset] - 128) + 128))/2);
			*pv++ = (v1 + v2) / 2;
		}
	}
}
...
{	
	...
	{
		/* y */
		*py++ =CLIP(0.299 * (in[i+2] - 128) + 0.587 * (in[i+1] - 128) + 0.114 * (in[i] - 128) + 128);
	}
	...
	for(h = 0; h < height; h += 2)
	{
		...
		{
			/* u */
			uint8_t u1 = CLIP(((- 0.147 * (in[i+2] - 128) - 0.289 * (in[i+1] - 128) + 0.436 * (in[i] - 128) + 128) +
				(- 0.147 * (in[i+5] - 128) - 0.289 * (in[i+4] - 128) + 0.436 * (in[i+3] - 128) + 128))/2);
			uint8_t u2 = CLIP(((- 0.147 * (in[i+2+offset] - 128) - 0.289 * (in[i+1+offset] - 128) + 0.436 * (in[i+offset] - 128) + 128) +
				(- 0.147 * (in[i+5+offset] - 128) - 0.289 * (in[i+4+offset] - 128) + 0.436 * (in[i+3+offset] - 128) + 128))/2);
			*pu++ = (u1 + u2) / 2;
			/* v*/
			uint8_t v1 =CLIP(((0.615 * (in[i+2] - 128) - 0.515 * (in[i+1] - 128) - 0.100 * (in[i] - 128) + 128) +
				(0.615 * (in[i+5] - 128) - 0.515 * (in[i+4] - 128) - 0.100 * (in[i+3] - 128) + 128))/2);
			uint8_t v2 =CLIP(((0.615 * (in[i+2+offset] - 128) - 0.515 * (in[i+1+offset] - 128) - 0.100 * (in[i+offset] - 128) + 128) +
				(0.615 * (in[i+5+offset] - 128) - 0.515 * (in[i+4+offset] - 128) - 0.100 * (in[i+3+offset] - 128) + 128))/2);
			*pv++ = (v1 + v2) / 2;
		}
	}
